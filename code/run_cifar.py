...
from tasks.cifar import Net, cifar
...
# Attacks
from attacks import BitFlippingWorker, LableFlippingWorker, \
...
from utils.byz_funcs import get_sampler_callback, get_aggregator, \
...
def main(args):
    ...
    # info like `momentum_buffer`
    optimizers = [torch.optim.SGD(model.parameters(),
                                  lr=args.lr) for _ in range(args.n)]
    optimizers_snap = [torch.optim.SGD(model_snap_s[i].parameters(),
    ...
    if not args.dry_run:
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            trainer.train(
                ...
                args.clip_update, args.clip_mult)
