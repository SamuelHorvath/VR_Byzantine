...
# Utility functions
from tasks.mnist import mnist, Net
from tasks.loss import Loss
from utils.utils import top1_accuracy, create_model_dir, init_metrics_meter, extend_metrics_dict, metric_to_dict
...
def initialize_worker(
    ...
    train_loader = mnist(
        ...
        drop_last=False,  # Exclude the influence of non-full batch.
        **kwargs,
    )
